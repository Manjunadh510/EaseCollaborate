...
import { UseProjectQuery, useDeleteProjectMutation } from "../../../../hooks/use-project";
import { getProjectProgress } from "../../../../lib";
import { cn } from "../../../../lib/utils";
import type { Project, Task, TaskStatus } from "../../../../types";
import { format } from "date-fns";
import { AlertCircle, Calendar, CheckCircle, Clock, Pencil, Trash2 } from "lucide-react";
...
const ProjectDetails = () => {
  ...
  const projectCreatorId =
    typeof project.createdBy === "string" ? project.createdBy : project.createdBy?._id;
        ...
        <Tabs defaultValue="all" className="w-full">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
            ...
            <div className="flex items-center text-sm">
              <span className="text-muted-foreground m-1">Status :</span>
              <div>
                <Badge variant="outline" className="bg-background p-3 m-1">
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              be undone. All tasks in this project will be permanently deleted.
            </AlertDialogDescription>
          </AlertDialogHeader>
